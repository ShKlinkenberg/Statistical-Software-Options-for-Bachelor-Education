...
The following chapters give an overview of the different options available for under graduate education, providing an overview of the pro's and con's per application. we will cover the multiple applications ranging from SPSS to Python and Jupyter Notebooks and LLM ChatGPT Data Analyst. 
