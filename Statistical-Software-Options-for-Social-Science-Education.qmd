...
The following chapters give an overview of the different options available for under graduate education, providing an overview and reflection per application. We broadly define five categories of software.
...
Both packages are still struggling with the data editor. The graphical user interface for both is not really intuitive, though both do allow to use R code to calculate columns.
...
Using a statistical programming language this can be made more tangible by using code. This helps students focus on the concepts without the fear of miscalculations.
...
::: {#fig-ChatGPT-analysis}
![](ScatterPlot.png){width=60% fig-align="left"}

View ChatGPT chat [here](https://chatgpt.com/share/6810d51c-48f8-8007-8691-e5b07b12c063)
