...
A second consideration is the learning curve and didactical benefits of the software. The software should be easy to learn and use, and should provide a good balance between functionality and usability. The software should also be suitable for the level of the students, and should provide a good introduction to statistical analysis.
...
|------------|----------|----------|
| Bachelor 1 | Excel + SPSS | Excel for statistical calculations and table visualisations; SPSS for introductory statistical analysis. |
...
In a short survey among the scientific staff of the department of communication science, we asked an open question about the use of statistical software in their research and teaching. The categorised results are shown in @tbl-software-use-categorized. In total we received 64 responses, which is a response rate of about `r 64/192`%. The results in @tbl-software-use show that the majority of the staff uses R (63%) and SPSS (67%) in their research. Python is used by 22%. 
